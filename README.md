...
(If the image above does not load, go to [https://drive.google.com/uc?id=1thSkdrvRD7MYO1A7DJx73dzA6JygUZ-b](https://drive.usercontent.google.com/download?id=1thSkdrvRD7MYO1A7DJx73dzA6JygUZ-b&authuser=0))
#
#### Repo:
- GitHub repository: `holbertonschool-softy-pinko-docker`
- Directory: `task1`
...
With the `softy-pinko-front-end` directory and files in place, we need to create a new `Dockerfile` in your `task2/front-end` directory. In order to host and distribute our front-end content we will use a static web server named [Nginx](https://www.f5.com/go/product/welcome-to-nginx); there are many others that can be used, but this one is rather simple to get started with and conveniently has a Docker image that we can use which is pre-installed.
...
If the image above does not load, go to [https://drive.google.com/file/d/125rrSKiRI2whr4Uv9ydnJ5ZpcYWCIixQ](https://drive.google.com/file/d/125rrSKiRI2whr4Uv9ydnJ5ZpcYWCIixQ/view)
#
#### Repo:
- GitHub repository: `holbertonschool-softy-pinko-docker`
- Directory: `task2`
...
If the image above does not load, go to [https://drive.google.com/uc?id=18x9WulYaB3QTAxIsZbnypL3L95UGYkWc](https://drive.usercontent.google.com/download?id=18x9WulYaB3QTAxIsZbnypL3L95UGYkWc&authuser=0)
#
#### Repo:
- GitHub repository: `holbertonschool-softy-pinko-docker`
- Directory: `task3`
